...
- [ ] Save important files in `/etc` and `/home/tomh` to the `2023-32A` thumb drive in subdirectories of `for_25.10_on_barbara`
- [ ] Save network configuration for static on `barbara` to the `2023-32A` thumb drive
