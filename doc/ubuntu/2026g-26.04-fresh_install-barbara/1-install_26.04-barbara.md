...
# 1-install_26.04-barbara.md

Time to install 26.04 on barbara.
...
The remaining `*-checklist-*` files in this directory contain steps that depend, to a varying extent, on the specific host.
