...
- [ ] Move tab to the left
  - [ ] Click on Ctrl+Alt+Left -> If a dialog box appears asking for permission to change this, Click on Allow
  - [ ] Click on Ctrl+Alt+Left -> Click on Custom -> Click on None -> Press Shift+Ctrl+Left arrow -> Click on Reassign
- [ ] Move tab to the right
  - [ ] Click on Ctrl+Alt+Right -> Click on Custom -> Click on None -> Press Shift+Ctrl+Right arrow -> Click on Reassign
- [ ] Click on OK to close the dialog box
- [ ] Test moving the current tab to the left by pressing Shift+Ctrl+Left Arrow
- [ ] Test moving the current tab to the right by pressing Shift+Ctrl+Right Arrow
